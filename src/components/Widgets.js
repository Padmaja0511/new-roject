...
export const DeviceWidget = (props) => {
  ...
  return (
    <Card border="light" className="shadow-sm">
      <Card.Header style={{ backgroundColor: '#3c4b64', color: 'white' }}>VENDORS</Card.Header>
      <Card.Body>
...
export const TypeWidget = (props) => {
  ...
  return (
    <Card border="light" className="shadow-sm">
      <Card.Header style={{ backgroundColor: '#3c4b64', color: 'white' }}>DEVICES</Card.Header>
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          {types.map(it => 
          <Col >
